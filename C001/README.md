...
| Contest Submissions | [Code(python)](https://github.com/SehyunPark/Projects/blob/main/C001/Submission_Code(Python).ipynb) [Code(python) Packages List(Version included)]() <br> [Presentation Slides](https://github.com/SehyunPark/Projects) |
